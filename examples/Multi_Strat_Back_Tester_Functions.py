...
def calculate_rsi(df, price_metric):
    ...
    for period in range(3, 22, 2):  # End at 21 to include 20
...
def add_signal_markers(df, signal_column='signal_column', price_col='close', buy_marker='buy_marker', sell_marker='sell_marker', neutral_marker='neutral_marker'):
    """
